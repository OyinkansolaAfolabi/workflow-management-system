...
CREATE TABLE `tasks` (
  ...
  `status` varchar(30) NOT NULL DEFAULT 'pending' COMMENT '''pending'', ''in_progress'', ''completed''',
  `due_date` date NOT NULL,
  `review_date` date DEFAULT NULL,
  `visible_to_all` int(11) NOT NULL DEFAULT 0,
...
CREATE TABLE `users` (
  ...
  `account_type` varchar(15) NOT NULL DEFAULT 'user',
